        ...
        <div className="flex gap-2">
           <div className="relative flex-1 md:w-64">
               <button 
                    ...
                    className="absolute left-3 top-1/2 -translate-y-1/2 text-stone-400 hover:text-stone-800 transition-colors"
                >
               ...
               <input 
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-stone-800 bg-white"
               />
           </div>
           <button 
